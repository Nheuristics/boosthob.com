        ...
        <React.Fragment>
            <div className='container'>
                ...
                <div className='text-center marginTop3'>
                    <a className='SL-HLine marginTop5'>
                    ...
                    <div className='row marginTop5' >
                        <div className='col-lg-3' style={{position: "static"}}>
                            ...
                            <div className='text-center marginTop5'>
                                <a className='SL-LName'>C++20</a>
                            </div>
                        </div>
                        <div className='col-lg-3' style={{position: "static"}}>
                            <img src='assets/images/c.svg' />
                            <div className='text-center marginTop5'>
                                <a className='SL-LName'>C-98</a>
                            </div>
                        </div>
                        <div className='col-lg-3' style={{position: "static"}}>
                            <img src='assets/images/python.svg' />
                            <div className='text-center marginTop5'>
                                <a className='SL-LName'>Python-3.6</a>
                            </div>
                        </div>
                        <div className='col-lg-3' style={{position: "static"}}>
                            <img src='assets/images/csharp.svg' />
                            <div className='text-center marginTop5'>
                                <a className='SL-LName'>C#</a>
                            </div>
                        </div>
                    </div>
                    <div className='row marginTop5'>
                        <div className='col-lg-3' style={{position: "static"}}>
                            ...
                            <div className='text-center marginTop5'>
                                <a className='SL-LName'>Java</a>
                            </div>
                        </div>
                        <div className='col-lg-3' style={{position: "static"}}>
                            <img src='assets/images/javascript.svg' />
                            <div className='text-center marginTop5'>
                                <a className='SL-LName'>Javascript</a>
                            </div>
                        </div>
                        <div className='col-lg-3' style={{position: "static"}}>
                            <img src='assets/images/go.svg' />
                            <div className='text-center marginTop5'>
                                <a className='SL-LName'>Go Lang</a>
                            </div>
                        </div>
                        <div className='col-lg-3' style={{position: "static"}}>
                            <img src='assets/images/ruby.svg' />
                            <div className='text-center marginTop5'>
                                <a className='SL-LName'>Ruby</a>
                            </div>
                        </div>
                    </div>
                </div>
